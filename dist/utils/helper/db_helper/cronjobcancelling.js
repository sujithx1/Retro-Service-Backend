...
exports.stopBookingCronJob = exports.startBookingCronJob3min = void 0;
...
const startBookingCronJob3min = () => {
    ...
    bookingCronJob = node_cron_1.default.schedule("* * * * *", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const result = yield reqserviceMechanics_1.Request_Service_Mech_model.updateMany({ status: "PENDING", createdAt: { $lte: threeMinutesAgo } }, // Find pending bookings older than 1 min
...
exports.startBookingCronJob3min = startBookingCronJob3min;
