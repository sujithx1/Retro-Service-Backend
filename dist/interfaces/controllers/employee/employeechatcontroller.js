...
class EmployeeChatcontroller {
    constructor(getchatsEmployeeSide) {
        this.getchatsEmployeeSide = getchatsEmployeeSide;
    }
    getemployeeChat_employeeid(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                if (!id)
                    return next(new custom_errors_1.CustomError("missing id", 401, error_enum_1.AppError.ValidationError));
                const chats = yield this.getchatsEmployeeSide.execute(id);
