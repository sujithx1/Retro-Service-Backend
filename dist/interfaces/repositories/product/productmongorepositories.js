...
const returnproduct = (product) => {
    return new ProductEntities_1.Product_Entities(product._id.toString(), product.storeId.toString(), product.name, product.description, product.stock, product.category.toString(), product.price, product.images, product.isBlock, product.createdAt, product.updatedAt);
};
