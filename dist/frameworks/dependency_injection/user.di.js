...
const getByAdminId_1 = require("../../use-cases/wallet/getByAdminId");
...
const getService_booking = new get_req_service_1.User_getReqServiceuseCase(reqServiceMechanicsRepositories);
const getadminWallet = new getByAdminId_1.AdminGetWalletuseCase(walletRepositories);
...
exports.serviceController = new UserserviceController_1.UserServiceController(createreqservicemechanics, getreqservice, ConfirmServicePayment, getbookingHistory, cancellBookingService, getServicePayment, serachjobsuser, getnearestEmployees10km, putserviceSendSpecificEmployee, createServicepayment, gettranasactionByuser, getService_booking);
exports.userChatController = new userChatcontroller_1.UserChatcontroller(getMessagesByUser);
exports.userWalletController = new userWalletcontroller_1.UserwalletController(usergetwallet, getadminWallet);
