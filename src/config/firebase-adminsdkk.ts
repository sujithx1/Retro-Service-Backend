...
export const authProviderCertUrl = process.env.FIREBASE_AUTH_PROVIDER_X509_CERT_URL;
export const clientCertUrl = process.env.FIREBASE_CLIENT_X509_CERT_URL;
export const universeDomain = process.env.FIREBASE_UNIVERSE_DOMAIN;
